...
public abstract class FloatWindowService extends Service {
    static final String TAG = "floating";
     ...
     * @param cls
     *            The Service extending {@link FloatWindowService} that will be used
    ...
    public static void show(Context context,
            Class<? extends FloatWindowService> cls, int id) {
     ...
     *            A Context of the application package implementing this class.
     * @param cls
     *            The Service extending {@link FloatWindowService} that is managing
     *            the window.
     * @param id
    ...
    public static void closeAll(Context context,
            Class<? extends FloatWindowService> cls) {
     ...
     *            the sending window.
     * @param toCls
     *            The Service's class extending {@link FloatWindowService} that is
    ...
    public static void sendData(Context context,
            Class<? extends FloatWindowService> toCls, int toId,
            int requestCode, Bundle data,
            Class<? extends FloatWindowService> fromCls, int fromId) {
    ...
    static FloatView sFocusedWindow;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            if (ACTION_SHOW.equals(action) || ACTION_RESTORE.equals(action)) {
                ...
                Class<? extends FloatWindowService> fromCls = (Class<? extends FloatWindowService>) intent
    ...
    public abstract void startChatService();

    public abstract void stopChatService();
    ...
    /**
     * Return the {@link FloatWindowService#LayoutParams} for the corresponding id.
     ...
     * @return The {@link FloatWindowService#LayoutParams} corresponding to the id.
     ...
     */
    public abstract StandOutLayoutParams getParams(int id, FloatView window);
    ...
    public PopupWindow getDropDown(final int id) {
        ...
        if (dropDownListItems != null) {
            ...
            items = new ArrayList<FloatWindowService.DropDownListItem>();
        }
     ...
     *            See linked method.
     */
    public boolean onTouchBody(int id, FloatView window, View view,
            MotionEvent event) {
        return false;
    }
     ...
     */
    public void onMove(int id, FloatView window, View view, MotionEvent event) {
    }
     ...
     * @param event
     *            See linked method.
     * @see {@link #onTouchHandleResize(int, FloatView, View, MotionEvent)}
     */
    public void onResize(int id, FloatView window, View view, MotionEvent event) {
    }
     ...
     * @see #show(int)
     */
    public boolean onShow(int id, FloatView window) {
        return false;
    }
     ...
     * @see #hide(int)
     */
    public boolean onHide(int id, FloatView window) {
        return false;
    }
     ...
     * @see #close(int)
     */
    public boolean onClose(int id, FloatView window) {
        return false;
    }
     ...
     *         continue.
     * @see #updateViewLayout(int, FloatView, StandOutLayoutParams)
     */
    public boolean onUpdate(int id, FloatView window,
            StandOutLayoutParams params) {
        return false;
    }
     ...
     */
    public boolean onBringToFront(int id, FloatView window) {
        return false;
    }
     ...
     * @see #focus(int)
     */
    public boolean onFocusChange(int id, FloatView window, boolean focus) {
        return false;
    }
     ...
     * handles the event with {@link FloatView#dispatchKeyEvent(KeyEvent)}.
     * 
     * @param id
     *            The id of the window, provided as a courtesy.
     * @param view
     ...
     * @see {@link FloatView#dispatchKeyEvent(KeyEvent)}
     */
    public boolean onKeyEvent(int id, FloatView window, KeyEvent event) {
        return false;
    }
    ...
    public final synchronized FloatView show(int id) {
        ...
        if (onShow(id, window)) {
            Log.d(TAG, "FloatingView " + id
                    + " show cancelled by implementation.");
            return null;
        }

        // focus an already shown window
        if (window.visibility == FloatView.VISIBILITY_VISIBLE) {
            Log.d(TAG, "FloatingView " + id + " is already shown.");
            focus(id);
            return window;
        }
    ...
    public final synchronized void hide(int id) {
        ...
        if (window.visibility == FloatView.VISIBILITY_GONE) {
                ...
                animation.setAnimationListener(new AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        ...
                        sWindowCache.removeCache(id,
                                FloatWindowService.this.getClass());
    ...
    public final void sendData(int fromId,
            Class<? extends FloatWindowService> toCls, int toId,
            int requestCode, Bundle data) {
        FloatWindowService.sendData(this, toCls, toId, requestCode, data,
                getClass(), fromId);
    }
     ...
     */
    public final FloatView getFocusedWindow() {
     ...
     */
    public final void setFocusedWindow(FloatView window) {
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (event.getPointerCount() == 1) {
                ...
                if (tap
                    ...
                    FloatWindowService.this.bringToFront(id);
                }
            }
     ...
     * @return
     */
    public boolean onTouchHandleResize(int id, FloatView window, View view,
            MotionEvent event) {
     ...
     * @return True if focus changed successfully, false if it failed.
     */
    public synchronized boolean unfocus(FloatView window) {
        if (window == null) {
